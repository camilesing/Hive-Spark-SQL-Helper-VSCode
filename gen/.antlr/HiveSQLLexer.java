// Generated from /Users/camile/Work/opensource/hive-sql-helper-vscode/gen/HiveSQL.g4 by ANTLR 4.13.1
...
public class HiveSQLLexer extends Lexer {
	...
	public static final int
		...
		RPAREN=387, LSQUARE=388, RSQUARE=389, LCURLY=390, RCURLY=391, UNDERLINE_SIGN=392, 
		EQUAL=393, EQUAL_NS=394, NOTEQUAL=395, LESSTHANOREQUALTO=396, LESSTHAN=397, 
		GREATERTHANOREQUALTO=398, GREATERTHAN=399, DIVIDE=400, PLUS=401, MINUS=402, 
		STAR=403, MOD=404, DIV=405, AMPERSAND=406, TILDE=407, BITWISEOR=408, CONCATENATE=409, 
		BITWISEXOR=410, QUESTION=411, DOLLAR=412, StringLiteral=413, CharSetLiteral=414, 
		IntegralLiteral=415, NumberLiteral=416, ByteLengthLiteral=417, Number=418, 
		Identifier=419, CharSetName=420, WHITE_SPACE=421, LINE_COMMENT=422, QUERY_HINT=423, 
		SHOW_HINT=424, HIDDEN_HINT=425;
